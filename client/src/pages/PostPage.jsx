...
export default function PostPage() {
  ...
  return (
    <main className="p3 flex flex-col max-w-6xl mx-auto min-h-screen">
      ...
      />
      <div className="flex justify-start p-3 border-b border-slate-500 mx-auto max-w-2xl text-xs">
        <span>
